...
Proof.
  intros X Y f. induction l as [| x l' IHl'].
  - simpl. reflexivity.
...
Example fold_example4 :
  fold (fun l acc => (fold plus l 0) + acc) [[1];[];[2;3];[4]] 0 = 10.
Proof. simpl. reflexivity. Qed.
...
Proof.
  intros X l n H. rewrite <- H.
  rewrite nth_error_length_l. reflexivity.
Qed.
