...
Proof. reflexivity. Qed.
Example test_monochrome4: monochrome (primary green) = false.
Proof. reflexivity. Qed.
Example test_monochrome5: monochrome (primary blue) = false.
Proof. reflexivity. Qed.
...
Proof.
  intros [l []].
  - intros. simpl. rewrite -> letter_comparison_Eq. reflexivity.
  - intros. simpl. rewrite -> letter_comparison_Eq. reflexivity.
  - destruct l.
    + simpl. intros. reflexivity.
    + simpl. intros. reflexivity.
